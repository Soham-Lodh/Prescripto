            ...
            <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
                <div>
                    ...
                    <p className="w-full md:w-2/3 text-gray-600 leading-6 text-justify">
                        Prescripto is an intuitive web application designed to simplify doctor appointment bookings. 
                        It allows users to view detailed doctor profiles, check real-time availability, and reserve time slots seamlessly. 
                        With a focus on user-friendly navigation and secure scheduling, Prescripto streamlines the healthcare booking experience for both patients and healthcare providers.
                    </p>
                </div>
