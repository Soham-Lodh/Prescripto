          ...
          : doctors.slice(0, doctorCount).map((item, index) => (
              ...
              >
                <FlipCard
                  ...
                  frontContent={
                    <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full shadow-md hover:shadow-xl cursor-pointer transition-all">
