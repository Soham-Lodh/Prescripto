...
const Header = () => {
  ...
  return (
    <div className="mt-6 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="flex flex-col md:flex-row flex-wrap bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-3xl shadow-2xl overflow-hidden max-w-7xl mx-auto">
        {/* Left Content Section */}
        <div className="md:w-1/2 flex flex-col items-start justify-center gap-6 py-12 px-8 md:px-12 lg:px-16 md:py-[10vw] md:mb-[-30px] z-10">
          {/* Main Heading */}
        ...
        <div className="md:w-1/2 relative flex items-end justify-center md:justify-end">
          ...
          {/* Main Image */}
          <img
            className="w-full md:w-auto md:h-[600px] lg:h-[700px] object-contain md:absolute bottom-0 right-0 drop-shadow-2xl relative z-10"
