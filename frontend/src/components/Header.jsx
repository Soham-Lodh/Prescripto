  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-[rgb(95,111,255)] rounded-lg px-6 md:px-10 lg:px-20">
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
        <p className="text-2xl md:text-3xl lg:text-3xl text-white font-bold lg:leading-tight">Book Appointment<br/>With trusted doctors</p>
        <div className="flex flex-col md:flex-row items-center text-white text-md font-light">
          <img className="w-30 pr-2" src={assets.group_profiles} alt="Group Photo"/>
          <p>
