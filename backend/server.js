...
app.use(
  cors({
    origin: ["http://localhost:5173", "http://localhost:5174","https://prescripto-frontend-yxxn.onrender.com","https://prescripto-o6es.onrender.com","https://prescripto-o5lf.vercel.app"],
    credentials: true,
  })
);
